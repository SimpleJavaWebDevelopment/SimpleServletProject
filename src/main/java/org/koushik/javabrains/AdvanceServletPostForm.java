...
public class AdvanceServletPostForm extends HttpServlet {

	private static final long serialVersionUID = 1L;
	
		/**
		 * @see HttpServlet#doGet(HttpServletRequest request, HttpServletResponse response)
		 * http://localhost:8080/SimpleServletProject/AdvanceServletPath?userName=Vikash&userId=1234
		 */
		protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
			System.out.println("Hello from AdvanceServletPostForm::Get Method");
			...
			writer.println("Hello from AdvanceServletPostForm::Get Method");
